...
SECP256r1 = Curve("SECP256r1", ecdsa.curve_secp256r1,
                  ecdsa.generator_secp256r1,
                  (1, 3, 132, 0, 10), "secp256r1")

curves = [NIST192p, NIST224p, NIST256p, NIST384p, NIST521p, SECP256k1, SECP256r1]
